...
export async function localProfileCreate(name: string, avatar: string, pin: string | null): Promise<LocalProfile> {
...
export async function localProfileDelete(id: string): Promise<void> {
