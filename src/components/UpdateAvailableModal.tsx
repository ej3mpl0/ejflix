...
export function UpdateAvailableModal() {
  ...
  return (
    <Dialog
      ...
      onEscape={working ? undefined : later}
      className="max-h-[calc(100vh-2rem)] w-[min(520px,92vw)] overflow-y-auto rounded-card bg-surface p-6 md:p-8 shadow-[0_24px_64px_rgb(0_0_0_/_0.45),0_0_0_1px_rgb(255_255_255_/_0.06)]"
    >
      ...
      <p className="mt-2 text-center text-[12px] text-dim">
        {installError ? (
          <span className="text-danger">{t("updateDownloadError", { error: installError })}</span>
        ) : check.assetUrl ? (
          t("updateInstallHint")
        ) : (
          t("updateNoAsset")
