...
export function UpdateModal({ version, onClose }: { version: string; onClose: () => void }) {
  ...
  return (
    <Dialog
      labelledBy="updated-title"
      onEscape={onClose}
      className="flex max-h-[calc(100vh-2rem)] w-[min(440px,92vw)] flex-col rounded-card bg-surface p-6 shadow-[0_24px_64px_rgb(0_0_0_/_0.45),0_0_0_1px_rgb(255_255_255_/_0.06)] md:p-8"
    >
      ...
      <h2 id="updated-title" className="mb-5 text-center text-[20px] font-semibold">{t("updatedTo", { version })}</h2>
